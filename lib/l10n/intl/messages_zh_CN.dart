...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "xbAccountRequired": MessageLookupByLibrary.simpleMessage("请先登录"),
    "xbAnnouncement": MessageLookupByLibrary.simpleMessage("公告"),
    "xbAutoRegion": MessageLookupByLibrary.simpleMessage("自动（最优地域）"),
    "xbAutoShort": MessageLookupByLibrary.simpleMessage("自动"),
    "xbBackToAccount": MessageLookupByLibrary.simpleMessage("返回我的"),
    "xbBalance": MessageLookupByLibrary.simpleMessage("余额"),
    "xbBuyNow": MessageLookupByLibrary.simpleMessage("立即开通"),
    "xbBuyPendingTip": MessageLookupByLibrary.simpleMessage("在线支付即将上线，敬请期待"),
    "xbCancelOrderConfirm": MessageLookupByLibrary.simpleMessage(
      "取消后将关闭未支付订单，确定？",
    ),
    "xbCancelOrderTitle": MessageLookupByLibrary.simpleMessage("取消订单"),
    "xbCheckout": MessageLookupByLibrary.simpleMessage("收银台"),
    "xbConfirmCancel": MessageLookupByLibrary.simpleMessage("确定要取消吗？"),
    "xbContinuePay": MessageLookupByLibrary.simpleMessage("继续支付"),
    "xbDataUpdated": MessageLookupByLibrary.simpleMessage("数据更新于"),
    "xbDirectModeTip": MessageLookupByLibrary.simpleMessage(
      "直连模式下所有流量不经代理，不使用节点",
    ),
    "xbDomainChangedTip": MessageLookupByLibrary.simpleMessage(
      "面板主域名当前不可达，可一键重试或手动输入新的入口域名。",
    ),
    "xbDomainChangedTitle": MessageLookupByLibrary.simpleMessage("服务入口已变更"),
    "xbDomainInvalid": MessageLookupByLibrary.simpleMessage(
      "地址无效，仅支持 http(s) 地址",
    ),
    "xbDomainManual": MessageLookupByLibrary.simpleMessage("输入新域名"),
    "xbDomainManualHint": MessageLookupByLibrary.simpleMessage(
      "https://example.com",
    ),
    "xbDomainManualTitle": MessageLookupByLibrary.simpleMessage("输入新入口域名"),
    "xbDomainRetry": MessageLookupByLibrary.simpleMessage("一键重试"),
    "xbDomainUpdated": MessageLookupByLibrary.simpleMessage("域名已更新，正在重新探测"),
    "xbEmail": MessageLookupByLibrary.simpleMessage("邮箱"),
    "xbEmailCode": MessageLookupByLibrary.simpleMessage("邮箱验证码"),
    "xbExpireAt": MessageLookupByLibrary.simpleMessage("到期时间"),
    "xbFollowSystem": MessageLookupByLibrary.simpleMessage("跟随系统"),
    "xbForgetPassword": MessageLookupByLibrary.simpleMessage("忘记密码"),
    "xbHasAccount": MessageLookupByLibrary.simpleMessage("已有账号？登录"),
    "xbInviteAvailable": MessageLookupByLibrary.simpleMessage("可用佣金"),
    "xbInviteCode": MessageLookupByLibrary.simpleMessage("邀请码"),
    "xbInviteCodeOptional": MessageLookupByLibrary.simpleMessage("邀请码（选填）"),
    "xbInviteCopied": MessageLookupByLibrary.simpleMessage("已复制"),
    "xbInviteCopyCode": MessageLookupByLibrary.simpleMessage("复制邀请码"),
    "xbInviteCopyError": MessageLookupByLibrary.simpleMessage("复制失败，请重试。"),
    "xbInviteCopyLink": MessageLookupByLibrary.simpleMessage("复制邀请链接"),
    "xbInviteCreate": MessageLookupByLibrary.simpleMessage("生成邀请码"),
    "xbInviteCreating": MessageLookupByLibrary.simpleMessage("正在生成…"),
    "xbInviteDescription": MessageLookupByLibrary.simpleMessage(
      "分享邀请链接或二维码，好友在网页注册后即可绑定邀请关系。",
    ),
    "xbInviteEmpty": MessageLookupByLibrary.simpleMessage("还没有可用的邀请码。"),
    "xbInviteLoadError": MessageLookupByLibrary.simpleMessage(
      "邀请信息暂时无法加载，请稍后重试。",
    ),
    "xbInvitePending": MessageLookupByLibrary.simpleMessage("确认中佣金"),
    "xbInviteQrLabel": MessageLookupByLibrary.simpleMessage("邀请注册二维码"),
    "xbInviteRefresh": MessageLookupByLibrary.simpleMessage("刷新"),
    "xbInviteRegistered": MessageLookupByLibrary.simpleMessage("已邀请注册"),
    "xbInviteSettlementNote": MessageLookupByLibrary.simpleMessage(
      "收益及结算以后台规则为准，注册成功不代表佣金已到账。",
    ),
    "xbInviteTitle": MessageLookupByLibrary.simpleMessage("邀请返利"),
    "xbInviteTotal": MessageLookupByLibrary.simpleMessage("累计佣金"),
    "xbInviteWebsiteUnavailable": MessageLookupByLibrary.simpleMessage(
      "邀请网页暂不可用，可先复制邀请码。请稍后刷新或联系客服。",
    ),
    "xbLoadBalance": MessageLookupByLibrary.simpleMessage("分流均衡"),
    "xbLoadBalanceDesc": MessageLookupByLibrary.simpleMessage(
      "同地域多节点粘滞均衡（sticky-sessions）",
    ),
    "xbLoadBalanceOff": MessageLookupByLibrary.simpleMessage("已关闭分流均衡"),
    "xbLoadBalanceOn": MessageLookupByLibrary.simpleMessage("已开启分流均衡"),
    "xbLogin": MessageLookupByLibrary.simpleMessage("登录"),
    "xbLoginSyncTip": MessageLookupByLibrary.simpleMessage("登录同步订阅信息"),
    "xbLoginTip": MessageLookupByLibrary.simpleMessage("登录后自动同步订阅"),
    "xbLogout": MessageLookupByLibrary.simpleMessage("退出登录"),
    "xbManagedSubscription": MessageLookupByLibrary.simpleMessage("托管订阅"),
    "xbMyOrders": MessageLookupByLibrary.simpleMessage("我的订单"),
    "xbNetworkError": MessageLookupByLibrary.simpleMessage("网络异常，请稍后重试"),
    "xbNewPassword": MessageLookupByLibrary.simpleMessage("新密码"),
    "xbNoAccount": MessageLookupByLibrary.simpleMessage("没有账号？注册"),
    "xbNoOrders": MessageLookupByLibrary.simpleMessage("暂无订单"),
    "xbNoPaymentMethod": MessageLookupByLibrary.simpleMessage(
      "支付方式暂未配置，请联系客服或稍后再试",
    ),
    "xbNoPlanTip": MessageLookupByLibrary.simpleMessage("开通套餐后节点与流量自动同步，一键连接"),
    "xbNoPlanTitle": MessageLookupByLibrary.simpleMessage("还没有可用订阅"),
    "xbOpenCashier": MessageLookupByLibrary.simpleMessage("打开支付页面"),
    "xbOpenCashierFailed": MessageLookupByLibrary.simpleMessage(
      "无法打开支付页面，请重试或选择其他支付方式。",
    ),
    ...
    "xbOrderPending": MessageLookupByLibrary.simpleMessage("待支付"),
    "xbOrderProcessing": MessageLookupByLibrary.simpleMessage("开通中"),
    "xbOrderUnknown": MessageLookupByLibrary.simpleMessage("未知"),
    "xbPassword": MessageLookupByLibrary.simpleMessage("密码"),
    "xbPayFailed": MessageLookupByLibrary.simpleMessage("支付未完成"),
    "xbPayPendingTip": MessageLookupByLibrary.simpleMessage("等待支付结果…"),
    "xbPayPollingTip": MessageLookupByLibrary.simpleMessage(
      "支付完成后本页将自动确认并同步订阅",
    ),
    "xbPaySuccess": MessageLookupByLibrary.simpleMessage("支付成功，套餐已生效"),
    "xbPeriodHalfYearly": MessageLookupByLibrary.simpleMessage("半年"),
    "xbPeriodMonthly": MessageLookupByLibrary.simpleMessage("月"),
    "xbPeriodOnetime": MessageLookupByLibrary.simpleMessage("一次性"),
    "xbPeriodQuarterly": MessageLookupByLibrary.simpleMessage("季"),
    "xbPeriodReset": MessageLookupByLibrary.simpleMessage("重置流量"),
    "xbPeriodThreeYearly": MessageLookupByLibrary.simpleMessage("三年"),
    "xbPeriodTwoYearly": MessageLookupByLibrary.simpleMessage("两年"),
    "xbPeriodYearly": MessageLookupByLibrary.simpleMessage("年"),
    "xbPlanCurrent": MessageLookupByLibrary.simpleMessage("当前套餐"),
    "xbRegionAE": MessageLookupByLibrary.simpleMessage("阿联酋"),
    "xbRegionAR": MessageLookupByLibrary.simpleMessage("阿根廷"),
    "xbRegionAU": MessageLookupByLibrary.simpleMessage("澳大利亚"),
    "xbRegionBR": MessageLookupByLibrary.simpleMessage("巴西"),
    "xbRegionCA": MessageLookupByLibrary.simpleMessage("加拿大"),
    "xbRegionCH": MessageLookupByLibrary.simpleMessage("瑞士"),
    "xbRegionDE": MessageLookupByLibrary.simpleMessage("德国"),
    "xbRegionFR": MessageLookupByLibrary.simpleMessage("法国"),
    "xbRegionHK": MessageLookupByLibrary.simpleMessage("香港"),
    "xbRegionID": MessageLookupByLibrary.simpleMessage("印尼"),
    "xbRegionIN": MessageLookupByLibrary.simpleMessage("印度"),
    "xbRegionIQ": MessageLookupByLibrary.simpleMessage("伊拉克"),
    "xbRegionJP": MessageLookupByLibrary.simpleMessage("日本"),
    "xbRegionKR": MessageLookupByLibrary.simpleMessage("韩国"),
    "xbRegionMY": MessageLookupByLibrary.simpleMessage("马来西亚"),
    "xbRegionNG": MessageLookupByLibrary.simpleMessage("尼日利亚"),
    "xbRegionNL": MessageLookupByLibrary.simpleMessage("荷兰"),
    "xbRegionPH": MessageLookupByLibrary.simpleMessage("菲律宾"),
    "xbRegionPreferred": MessageLookupByLibrary.simpleMessage("优选"),
    "xbRegionRU": MessageLookupByLibrary.simpleMessage("俄罗斯"),
    "xbRegionSG": MessageLookupByLibrary.simpleMessage("新加坡"),
    "xbRegionTH": MessageLookupByLibrary.simpleMessage("泰国"),
    "xbRegionTR": MessageLookupByLibrary.simpleMessage("土耳其"),
    "xbRegionTW": MessageLookupByLibrary.simpleMessage("台湾"),
    "xbRegionUA": MessageLookupByLibrary.simpleMessage("乌克兰"),
    "xbRegionUK": MessageLookupByLibrary.simpleMessage("英国"),
    "xbRegionUS": MessageLookupByLibrary.simpleMessage("美国"),
    "xbRegionVN": MessageLookupByLibrary.simpleMessage("越南"),
    "xbRegionZA": MessageLookupByLibrary.simpleMessage("南非"),
    "xbRegister": MessageLookupByLibrary.simpleMessage("注册"),
    "xbRenew": MessageLookupByLibrary.simpleMessage("续费"),
    "xbResetPassword": MessageLookupByLibrary.simpleMessage("重置密码"),
    "xbResetSubscription": MessageLookupByLibrary.simpleMessage("重置订阅"),
    "xbResetSubscriptionConfirm": MessageLookupByLibrary.simpleMessage(
      "重置后旧订阅地址立即失效，确定继续？",
    ),
    "xbRestricted": MessageLookupByLibrary.simpleMessage("受限"),
    "xbRestrictedPlans": MessageLookupByLibrary.simpleMessage("可用套餐"),
    "xbRestrictedTip": MessageLookupByLibrary.simpleMessage(
      "该地域需更高套餐权限，前往商店查看套餐",
    ),
    "xbScan": MessageLookupByLibrary.simpleMessage("扫码"),
    "xbScanToPay": MessageLookupByLibrary.simpleMessage("扫码支付"),
    "xbSelectPayment": MessageLookupByLibrary.simpleMessage("选择支付方式"),
    "xbSelectPeriod": MessageLookupByLibrary.simpleMessage("选择周期"),
    "xbSendCode": MessageLookupByLibrary.simpleMessage("发送验证码"),
    "xbSendCodeCooldown": MessageLookupByLibrary.simpleMessage("重新发送"),
    "xbStatusCongested": MessageLookupByLibrary.simpleMessage("拥挤"),
    "xbStatusFluent": MessageLookupByLibrary.simpleMessage("流畅"),
    "xbStatusNormal": MessageLookupByLibrary.simpleMessage("正常"),
    "xbStore": MessageLookupByLibrary.simpleMessage("商店"),
    "xbStoreEmpty": MessageLookupByLibrary.simpleMessage("暂无可售套餐"),
    ...
    "xbTrafficUsed": MessageLookupByLibrary.simpleMessage("已用流量"),
    "xbUnloggedIn": MessageLookupByLibrary.simpleMessage("未登录"),
    "years": m14,
  };
}
