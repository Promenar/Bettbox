...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "xbAnnouncement": MessageLookupByLibrary.simpleMessage("اطلاعیه‌ها"),
    "xbAutoShort": MessageLookupByLibrary.simpleMessage("خودکار"),
    "xbCancelOrderTitle": MessageLookupByLibrary.simpleMessage("لغو سفارش"),
    "xbConfirmCancel": MessageLookupByLibrary.simpleMessage("لغو شود؟"),
    "xbContinuePay": MessageLookupByLibrary.simpleMessage("ادامه پرداخت"),
    "xbDataUpdated": MessageLookupByLibrary.simpleMessage(
      "به‌روزرسانی داده‌ها",
    ),
    ...
    "xbLoginSyncTip": MessageLookupByLibrary.simpleMessage(
      "برای همگام‌سازی اشتراک وارد شوید",
    ),
    "xbMyOrders": MessageLookupByLibrary.simpleMessage("سفارش‌های من"),
    "xbNetworkError": MessageLookupByLibrary.simpleMessage(
      "خطای شبکه، بعداً دوباره تلاش کنید",
    ),
    "xbNoOrders": MessageLookupByLibrary.simpleMessage("سفارشی وجود ندارد"),
    "xbNoPlanTip": MessageLookupByLibrary.simpleMessage(
      "با تهیه پلن، گره‌ها و ترافیک خودکار همگام می‌شوند — اتصال با یک لمس",
    ),
    ...
    "xbOrderPending": MessageLookupByLibrary.simpleMessage("در انتظار پرداخت"),
    "xbOrderProcessing": MessageLookupByLibrary.simpleMessage(
      "در حال فعال‌سازی",
    ),
    "xbOrderUnknown": MessageLookupByLibrary.simpleMessage("نامشخص"),
    "xbPeriodHalfYearly": MessageLookupByLibrary.simpleMessage("شش‌ماهه"),
    "xbPeriodMonthly": MessageLookupByLibrary.simpleMessage("ماهانه"),
    "xbPeriodOnetime": MessageLookupByLibrary.simpleMessage("یک‌باره"),
    "xbPeriodQuarterly": MessageLookupByLibrary.simpleMessage("سه‌ماهه"),
    "xbPeriodReset": MessageLookupByLibrary.simpleMessage("بازنشانی ترافیک"),
    "xbPeriodThreeYearly": MessageLookupByLibrary.simpleMessage("سه‌ساله"),
    "xbPeriodTwoYearly": MessageLookupByLibrary.simpleMessage("دوساله"),
    "xbPeriodYearly": MessageLookupByLibrary.simpleMessage("سالانه"),
    "xbRegionAE": MessageLookupByLibrary.simpleMessage("امارات"),
    "xbRegionAR": MessageLookupByLibrary.simpleMessage("آرژانتین"),
    "xbRegionAU": MessageLookupByLibrary.simpleMessage("استرالیا"),
    "xbRegionBR": MessageLookupByLibrary.simpleMessage("برزیل"),
    "xbRegionCA": MessageLookupByLibrary.simpleMessage("کانادا"),
    "xbRegionCH": MessageLookupByLibrary.simpleMessage("سوئیس"),
    "xbRegionDE": MessageLookupByLibrary.simpleMessage("آلمان"),
    "xbRegionFR": MessageLookupByLibrary.simpleMessage("فرانسه"),
    "xbRegionHK": MessageLookupByLibrary.simpleMessage("هنگ‌کنگ"),
    "xbRegionID": MessageLookupByLibrary.simpleMessage("اندونزی"),
    "xbRegionIN": MessageLookupByLibrary.simpleMessage("هند"),
    "xbRegionIQ": MessageLookupByLibrary.simpleMessage("عراق"),
    "xbRegionJP": MessageLookupByLibrary.simpleMessage("ژاپن"),
    "xbRegionKR": MessageLookupByLibrary.simpleMessage("کره جنوبی"),
    "xbRegionMY": MessageLookupByLibrary.simpleMessage("مالزی"),
    "xbRegionNG": MessageLookupByLibrary.simpleMessage("نیجریه"),
    "xbRegionNL": MessageLookupByLibrary.simpleMessage("هلند"),
    "xbRegionPH": MessageLookupByLibrary.simpleMessage("فیلیپین"),
    "xbRegionPreferred": MessageLookupByLibrary.simpleMessage("پیشنهادی"),
    "xbRegionRU": MessageLookupByLibrary.simpleMessage("روسیه"),
    "xbRegionSG": MessageLookupByLibrary.simpleMessage("سنگاپور"),
    "xbRegionTH": MessageLookupByLibrary.simpleMessage("تایلند"),
    "xbRegionTR": MessageLookupByLibrary.simpleMessage("ترکیه"),
    "xbRegionTW": MessageLookupByLibrary.simpleMessage("تایوان"),
    "xbRegionUA": MessageLookupByLibrary.simpleMessage("اوکراین"),
    "xbRegionUK": MessageLookupByLibrary.simpleMessage("بریتانیا"),
    "xbRegionUS": MessageLookupByLibrary.simpleMessage("آمریکا"),
    "xbRegionVN": MessageLookupByLibrary.simpleMessage("ویتنام"),
    "xbRegionZA": MessageLookupByLibrary.simpleMessage("آفریقای جنوبی"),
    "xbRestricted": MessageLookupByLibrary.simpleMessage("محدود"),
    "xbRestrictedPlans": MessageLookupByLibrary.simpleMessage("پلن‌های موجود"),
    "xbRestrictedTip": MessageLookupByLibrary.simpleMessage(
      "این منطقه به پلن بالاتر نیاز دارد — فروشگاه را ببینید",
    ),
    "xbScan": MessageLookupByLibrary.simpleMessage("اسکن"),
    "xbSubscriptionInactive": MessageLookupByLibrary.simpleMessage(
      "اشتراک هنوز فعال نیست — ابتدا پلن تهیه کنید",
    ),
    "xbUnloggedIn": MessageLookupByLibrary.simpleMessage("وارد نشده‌اید"),
    "years": m14,
  };
}
