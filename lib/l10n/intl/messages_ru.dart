...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "xbAnnouncement": MessageLookupByLibrary.simpleMessage("Объявления"),
    "xbAutoShort": MessageLookupByLibrary.simpleMessage("Авто"),
    "xbCancelOrderTitle": MessageLookupByLibrary.simpleMessage("Отмена заказа"),
    "xbConfirmCancel": MessageLookupByLibrary.simpleMessage("Отменить заказ?"),
    ...
    "xbLoginSyncTip": MessageLookupByLibrary.simpleMessage(
      "Войдите, чтобы синхронизировать подписку",
    ),
    "xbMyOrders": MessageLookupByLibrary.simpleMessage("Мои заказы"),
    "xbNetworkError": MessageLookupByLibrary.simpleMessage(
      "Ошибка сети, попробуйте позже",
    ),
    "xbNoOrders": MessageLookupByLibrary.simpleMessage("Заказов пока нет"),
    "xbNoPlanTip": MessageLookupByLibrary.simpleMessage(
      "Оформите тариф — узлы и трафик синхронизируются автоматически, подключение в один тап",
    ),
    ...
    "xbOrderPending": MessageLookupByLibrary.simpleMessage("Ожидает оплаты"),
    "xbOrderProcessing": MessageLookupByLibrary.simpleMessage("Активируется"),
    "xbOrderUnknown": MessageLookupByLibrary.simpleMessage("Неизвестно"),
    "xbPeriodHalfYearly": MessageLookupByLibrary.simpleMessage("Полгода"),
    "xbPeriodMonthly": MessageLookupByLibrary.simpleMessage("Месяц"),
    "xbPeriodOnetime": MessageLookupByLibrary.simpleMessage("Разовый"),
    "xbPeriodQuarterly": MessageLookupByLibrary.simpleMessage("Квартал"),
    "xbPeriodReset": MessageLookupByLibrary.simpleMessage("Сброс трафика"),
    "xbPeriodThreeYearly": MessageLookupByLibrary.simpleMessage("3 года"),
    "xbPeriodTwoYearly": MessageLookupByLibrary.simpleMessage("2 года"),
    "xbPeriodYearly": MessageLookupByLibrary.simpleMessage("Год"),
    "xbRegionAE": MessageLookupByLibrary.simpleMessage("ОАЭ"),
    "xbRegionAR": MessageLookupByLibrary.simpleMessage("Аргентина"),
    "xbRegionAU": MessageLookupByLibrary.simpleMessage("Австралия"),
    "xbRegionBR": MessageLookupByLibrary.simpleMessage("Бразилия"),
    "xbRegionCA": MessageLookupByLibrary.simpleMessage("Канада"),
    "xbRegionCH": MessageLookupByLibrary.simpleMessage("Швейцария"),
    "xbRegionDE": MessageLookupByLibrary.simpleMessage("Германия"),
    "xbRegionFR": MessageLookupByLibrary.simpleMessage("Франция"),
    "xbRegionHK": MessageLookupByLibrary.simpleMessage("Гонконг"),
    "xbRegionID": MessageLookupByLibrary.simpleMessage("Индонезия"),
    "xbRegionIN": MessageLookupByLibrary.simpleMessage("Индия"),
    "xbRegionIQ": MessageLookupByLibrary.simpleMessage("Ирак"),
    "xbRegionJP": MessageLookupByLibrary.simpleMessage("Япония"),
    "xbRegionKR": MessageLookupByLibrary.simpleMessage("Южная Корея"),
    "xbRegionMY": MessageLookupByLibrary.simpleMessage("Малайзия"),
    "xbRegionNG": MessageLookupByLibrary.simpleMessage("Нигерия"),
    "xbRegionNL": MessageLookupByLibrary.simpleMessage("Нидерланды"),
    "xbRegionPH": MessageLookupByLibrary.simpleMessage("Филиппины"),
    "xbRegionPreferred": MessageLookupByLibrary.simpleMessage("Рекомендуемые"),
    "xbRegionRU": MessageLookupByLibrary.simpleMessage("Россия"),
    "xbRegionSG": MessageLookupByLibrary.simpleMessage("Сингапур"),
    "xbRegionTH": MessageLookupByLibrary.simpleMessage("Таиланд"),
    "xbRegionTR": MessageLookupByLibrary.simpleMessage("Турция"),
    "xbRegionTW": MessageLookupByLibrary.simpleMessage("Тайвань"),
    "xbRegionUA": MessageLookupByLibrary.simpleMessage("Украина"),
    "xbRegionUK": MessageLookupByLibrary.simpleMessage("Великобритания"),
    "xbRegionUS": MessageLookupByLibrary.simpleMessage("США"),
    "xbRegionVN": MessageLookupByLibrary.simpleMessage("Вьетнам"),
    "xbRegionZA": MessageLookupByLibrary.simpleMessage("ЮАР"),
    "xbRestricted": MessageLookupByLibrary.simpleMessage("Ограничено"),
    "xbRestrictedPlans": MessageLookupByLibrary.simpleMessage(
      "Доступные тарифы",
    ),
    "xbRestrictedTip": MessageLookupByLibrary.simpleMessage(
      "Для этого региона нужен более высокий тариф — смотрите Магазин",
    ),
    "xbScan": MessageLookupByLibrary.simpleMessage("Сканировать"),
    "xbSubscriptionInactive": MessageLookupByLibrary.simpleMessage(
      "Подписка ещё не активна — оформите тариф",
    ),
    "xbUnloggedIn": MessageLookupByLibrary.simpleMessage("Нет входа"),
    "years": m14,
  };
}
